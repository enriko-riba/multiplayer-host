namespace MultiplayerHost.Abstract
{
    ...
    {
        /// <summary>
        /// Returns a collection off all users from the persistance layer.
        ...
        /// <summary>
        /// Returns a user from the persistance layer.
        /// </summary>
        ...
        /// <summary>
        /// Saves the user to the persistance layer.
        /// </summary>
        ...
        /// <summary>
        /// Permanently deletes the user from the persistance layer.
        /// </summary>
        /// <param name="user"></param>
        /// <returns></returns>
